...
def is_between_100_and_999(user_input_number):
    ...
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    result = None
    user_input_number_int = int(user_input_number)
    if user_input_number_int >= 100 and user_input_number_int < 1000:
        result = True
    else:
        result = False
    # ==================================
...
def get_strikes_or_ball(user_input_number, random_number):
    ...
    strike = 0
    ball = 0
    user_input_number_str = str(user_input_number)
    random_number_str = str(random_number)
    for i in range(3):
        if user_input_number_str[i] in random_number_str:
            if user_input_number_str[i] == random_number_str[i]:
                strike += 1
            else:
                ball += 1
    result = [strike, ball]
...
def is_yes(one_more_input):
    ...
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    result = None
    one_more_input_upper = one_more_input.upper()
    if one_more_input_upper == "Y" or one_more_input_upper == "YES":
        result = True
    else:
        result = False
    # ==================================
...
def is_no(one_more_input):
    ...
    result = None
    one_more_input_upper = one_more_input.upper()
    if one_more_input_upper == "N" or one_more_input_upper == "NO":
        result = True
    else:
        result = False
    # ==================================
...
def main():
    ...
    while not game_ended:
        ...
        if strike == 3:
            ...
            while one_more_input.upper() not in ["Y", "N", "YES", "NO"]:
